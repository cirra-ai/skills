...
- [Summer '26 Release Notes](https://help.salesforce.com/s/articleView?id=release-notes.salesforce_release_notes.htm&release=262&type=5) - Salesforce official release notes (LWC API 67.0, WITH SECURITY_ENFORCED removal in Apex)
...
- [Spring '26 Release Notes](https://help.salesforce.com/s/articleView?id=release-notes.salesforce_release_notes.htm&release=260&type=5) - Salesforce official release notes
