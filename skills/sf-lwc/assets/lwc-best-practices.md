...
```apex
// Always use WITH USER_MODE or stripInaccessible.
// Do NOT use WITH SECURITY_ENFORCED — it is removed in API 67.0 (Summer '26)
// and classes at that version no longer compile with it.
