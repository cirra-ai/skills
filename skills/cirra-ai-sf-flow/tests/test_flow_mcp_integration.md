...
| 3   | Deploy 5 valid flows (before-save, after-save, screen, scheduled, complex) | PASS   | All 5 returned `success: true`         |
| 4   | Deploy 1 invalid flow (scheduled, missing triggerType)                     | PASS   | API accepted it (success: true)        |
