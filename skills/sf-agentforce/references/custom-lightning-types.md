...
> Without Enhanced Chat V2, custom type UI components will not render.
          ...
          "body": [
            {
              ...
              "attributes": { "value": "Order #${orderId}" }
            }
          ]
        },
        {
...
```json
{
  ...
  "properties": {
    "street": { "type": "string", "title": "Street Address", "maxLength": 255 },
    ...
    "isDefault": { "type": "boolean", "title": "Default Address", "default": false }
  },
...
```json
{
  ...
  "fields": [
    ...
    },
    {
      "name": "city",
      "component": "lightning-input",
      "attributes": { "type": "text", "label": "City", "required": true }
    },
    {
      "name": "state",
      "component": "lightning-input",
      "attributes": { "type": "text", "label": "State/Province" }
    },
    {
      "name": "postalCode",
      "component": "lightning-input",
    ...
    },
    {
      "name": "isDefault",
      "component": "lightning-checkbox",
      "attributes": { "label": "Set as default address" }
    }
  ],
  "submitButton": { "label": "Save Address", "variant": "brand" }
}
```
...
{
  "component": "lightning-card",
  "attributes": { "title": "Shipping Address", "iconName": "standard:address" },
  "body": [
    {
    ...
    },
    {
      ...
      "attributes": { "label": "Default", "class": "slds-m-top_small" }
    }
  ]
}
```
...
| Area        | Do                                                | Don't                                  |
| ----------- | ------------------------------------------------- | -------------------------------------- |
| Schema      | Keep schemas focused on a single concept          | Nest objects more than 2 levels deep   |
| Schema      | Use meaningful property names and validation      | Create overly complex schemas          |
| Editor UX   | Group related fields, use appropriate input types | Require too many fields at once        |
| Editor UX   | Provide clear labels and placeholders             | Hide critical fields behind conditions |
| Renderer UX | Highlight important info, use visual hierarchy    | Display raw data without formatting    |
| Deployment  | Deploy LightningTypeBundle before GenAiFunction   | Reference undefined custom types       |
