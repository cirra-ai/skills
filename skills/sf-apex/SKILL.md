...
| Scenario                           | Use                                                                |
| ---------------------------------- | ------------------------------------------------------------------ |
| Standard async work / callouts     | **Queueable** (`Database.AllowsCallouts` when HTTP is needed)      |
| Post-queueable cleanup             | **`System.Finalizer`**                                             |
...
- **Queueable delay / dedup**: `AsyncOptions` (delay up to 10 minutes)
