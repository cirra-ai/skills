...
- **Summer '26 Release Notes** (current release baseline, API 67.0): https://help.salesforce.com/s/articleView?id=release-notes.salesforce_release_notes.htm&release=262&type=5
...
- **Summer '26 Release in a Box**: https://www.salesforce.com/en-us/wp-content/uploads/sites/4/documents/PDF/release-in-a-box-summer-26-v6.pdf
