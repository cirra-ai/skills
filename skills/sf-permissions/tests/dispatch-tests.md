...
- **Should ask user**: no
- **Follow-up skills**: `sf-permissions analyze`, `sf-permissions audit`
...
- **Should NOT call**: `metadata_create`, `metadata_update`, `metadata_delete`
- **Should ask user**: no
- **Follow-up skills**: `sf-permissions update`, `sf-permissions delete`, `sf-permissions hierarchy`
...
- **Should NOT call**: `metadata_create`, `metadata_update`, `sobject_dml`
- **Should ask user**: yes (confirm before destructive operation)
- **Follow-up skills**: `sf-permissions hierarchy`, `sf-permissions audit`
