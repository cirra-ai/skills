...
|-------|----------|--------|
| All Events deleted | 0 remaining with CirraTest_ prefix | |
...
| Check | Expected | Result |
|-------|----------|--------|
| All 6 flows deleted | No CirraTest_* flows remain | |
...
Filter for CirraTest_ — expect zero results.
...
Run a comprehensive check that nothing CirraTest_* remains.
