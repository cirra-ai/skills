...
| Apex scoring completes | All CirraTest_* classes scored | |
| Flow scoring completes | All CirraTest_* flows scored | |
...
| CirraTest_* artifacts appear | All test artifacts from Phase 1-3 included | |
...
| All CirraTest_* classes listed | >= 10 rows | |
...
|-------|----------|--------|
| Columns: Name, Type, Score, % | Yes | |
| All CirraTest_* flows listed | >= 6 rows | |
...
| Check | Expected | Result |
|-------|----------|--------|
| All CirraTest_* .cls files present | >= 10 files | |
...
| Check | Expected | Result |
|-------|----------|--------|
| All CirraTest_* .flow-meta.xml files present | >= 6 files | |
...
|----------|--------------|---------------|-------------|--------|
| CirraTest_AccountService | ___/150 | ___/150 | ___/150 | |
| CirraTest_AccountSelector | ___/150 | N/A | ___/150 | |
| CirraTest_AccountRevenueBatch | ___/150 | ___/150 | ___/150 | |
| TA_CirraTest_Account_SetDefaults | ___/150 | ___/150 | ___/150 | |
| CirraTest_Account_Before_Save | ___/110 | ___/110 | ___/110 | |
| CirraTest_Opp_After_Save_Task | ___/110 | ___/110 | ___/110 | |
| CirraTest_Case_Intake_Screen | ___/110 | ___/110 | ___/110 | |
| cirraTestAccountDashboard | ___/165 | ___/165 | ___/165 | |
| cirraTestAccountForm | ___/165 | ___/165 | ___/165 | |
| cirraTestConfirmModal | ___/165 | ___/165 | ___/165 | |
...
| All CirraTest_* counted | Matches Phase 1 artifact count | |
