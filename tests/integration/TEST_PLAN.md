...
directories. If any step fails unexpectedly, open `BUG_INVESTIGATION_GUIDE.md`,
follow the decision tree, reach a verdict in 2–3 steps, and move on.

---

## Smoke Test Gate

> **All three smoke tests must return "success" or a validation result (not a
> hook/subprocess error) before proceeding to Phase 1.** If TC-003 (metadata
> path) fails, skip Phase 1b entirely and mark all metadata tests in Phases 2,
> 3, and 4 as BLOCKED. Data tests (1a, 2 data section, 3 data section) can
> still proceed.
...
**Command:** MCP tool call or slash command
**Expected:**
