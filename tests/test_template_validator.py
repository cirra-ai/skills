"""Tests for cirra-ai-sf/skills/cirra-ai-sf-lwc/scripts/template_validator.py"""

from conftest import load_script

mod = load_script("cirra-ai-sf/skills/cirra-ai-sf-lwc/scripts/template_validator.py")
